...
public partial class Comment_AllComment : System.Web.UI.Page
{
...
#		endif
	...
	private void ShowAllComment()
	{
		...
		DataTable dt = ServerImpl.Instance.CommonStorageImpl.GetAllComment(currentUser.IsAdmin ? 0 : currentUser.ID);
