<%@ Page Language="C#" AutoEventWireup="true" Inherits="Core.Web.Lesktop_MsgHistory_MessageList_User" %>
...
<head runat="server">
	...
	<script type="text/javascript" language="javascript">
		...
		function Refresh()
		{
			...
			window.location = "MessageList_User.aspx?" + qs;
		}
